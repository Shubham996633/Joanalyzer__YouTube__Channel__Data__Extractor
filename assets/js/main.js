...
const searchInputbox = document.querySelector('#home__search-input');
...
const clicker = document.querySelector('.channel__name')
...
const subscribeB = document.querySelector('.subscribe__button')
